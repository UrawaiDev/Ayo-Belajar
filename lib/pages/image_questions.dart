...
class LocalQuestionWithImagePage extends StatefulWidget {
  ...
  @override
  _LocalQuestionWithImagePageState createState() =>
      _LocalQuestionWithImagePageState();
}

class _LocalQuestionWithImagePageState
    extends State<LocalQuestionWithImagePage> {
  ...
  Widget _generateRandomAnswer(
    ...
    double buttonHeight = SizeConfig.blockHeight * 0.63;
                  ...
                  onTap: () async {
                    ...
                    Timer(Duration(milliseconds: 500), () {
                      summaryList.add([
                        ...
                        // _filteredQuestion[answerProvider.indexQuestion][2]
                        //     .toString()
                        //     .toUpperCase(),
                  ...
                  if (_filteredQuestion.length == 0)
                    ...
                    return Column(
                      children: <Widget>[
                        ...
                        Consumer<Answer>(
                          builder: (context, answerProvider, _) => Container(
                            ...
                            child: Center(
                              ...
                              fadeInCurve: Curves.easeIn,
                              image: FileImage(
                                File(_filteredQuestion[
                                    answerProvider.indexQuestion][2]),
                              ),
                            )),
                          ),
                        ),
